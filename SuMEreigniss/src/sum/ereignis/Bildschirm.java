 ...
 public class Bildschirm extends JFrame
 {
   ...
   private int zHoehe = 0; private int zBreite = 0;
   ...
   protected Bildschirm(int pLinks, int pOben, int pBreite, int pHoehe, String pName, boolean pMitDoubleBuffering)
   {
     ...
     addWindowListener(new FensterTester(null));
     addComponentListener(new GroesseTester(null));
     this.hatPanel.addMouseMotionListener(new MausBeweger(null));
     this.hatPanel.addMouseListener(new MausTaster(null));
     this.hatPanel.addKeyListener(new TastenTester(null));
     this.hatPanel.addFocusListener(new FokusReaktor(null));
     if (pBreite == -1)
     {
     ...
     implements FocusListener
   {
     ...
     public void focusGained(FocusEvent e)
     {
       ...
       {
         Bildschirm.access$402(Bildschirm.this, true);
     ...
     public void focusLost(FocusEvent e)
     {
       if ((Bildschirm.this.kenntEreignisanwendung != null) && (Bildschirm.this.kenntEreignisanwendung.fuehrtAus()))
       {
         Bildschirm.access$402(Bildschirm.this, false);
